...
import com.niule.market.service.Code.BufferedImageLuminanceService;
...
public class QRCodeUtil {
    ...
    public static String decode(File file) throws Exception {
        ...
        BufferedImageLuminanceService source = new BufferedImageLuminanceService(image);
